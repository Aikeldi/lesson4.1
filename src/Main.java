...
public class Main {
    ...
    public static int medicDamage = 10;
    ...
    public static void medicHelper() {
        for (int i = 0; i < heroesHealth.length; i++) {
            if (heroesHealth[i] < 100 && heroesHealth[i] > 0 ) {
                Random r = new Random();
                int numOfHero = r.nextInt(heroesHealth.length);
                heroesHealth[i] = heroesHealth[numOfHero] + medicDamage;
            }
        }
    }
